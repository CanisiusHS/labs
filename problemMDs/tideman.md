...
![Five ballots, tie betweeen Alice and Bob](https://cs50.harvard.edu/ap/2021/curriculum/x/psets/3/fptp_ballot_1.png)

A plurality vote would here declare a tie between Alice and Bob, since each has two votes. But is that the right outcome?

There's another kind of voting system known as a ranked-choice voting system. In a ranked-choice system, voters can vote for more than one candidate. Instead of just voting for their top choice, they can rank the candidates in order of preference. The resulting ballots might therefore look like the below.

![Three ballots, with ranked preferences](https://cs50.harvard.edu/ap/2021/curriculum/x/psets/3/ranked_ballot_1.png)
...
![Nine ballots, with ranked preferences](https://cs50.harvard.edu/ap/2021/curriculum/x/psets/3/condorcet_1.png)
...
![Nine ballots, with ranked preferences](https://cs50.harvard.edu/ap/2021/curriculum/x/psets/3/condorcet_graph_1.png)
...
![Nine ballots, with ranked preferences](https://cs50.harvard.edu/ap/2021/curriculum/x/psets/3/no_condorcet_1.png)
...
![Nine ballots, with ranked preferences](https://cs50.harvard.edu/ap/2021/curriculum/x/psets/3/lockin.png)
